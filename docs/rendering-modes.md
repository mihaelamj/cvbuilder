...
| Explicit relevance selection is opt-in. | `selectedExperienceIDs` can keep specific work entries before recency limits are applied, but the renderer does not infer relevance. |
