...
| R18 | Accomplishment content renders verbatim, with no auto-inflation or fabricated metrics. | `Sources/CVBuilder/Rendering/Rendering.MarkdownDocumentRenderer.Sections.swift` | `accomplishment content renders verbatim without fabricated metrics` |
