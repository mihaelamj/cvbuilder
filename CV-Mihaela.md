...
**Education:**
- M.Sc. in Information and Speech Science
...
**Technologies:** Swift, SwiftUI, REST, OpenAPI, Swift Package Manager, Unit Testing, UI Testing, Structured Concurrency, SSE, OpenAPI, Swift Server
...
- [https://apps.apple.com/app/apple-store/id1163863113](https://apps.apple.com/app/apple-store/id1163863113)
...
**Technologies:** WebSockets, Swift, UIKit, Artificial Intelligence, Swift Package Manager, macOS, Unit Testing, AppKit

#### iRobot App
- Added features for the onboarding process
- Automated localization

**Technologies:** Swift, SwiftUI, Swift Package Manager, Objective-C, UIKit, UI in code, Unit Testing
...
**Technologies:** Objective-C, Swift, UIKit, UI in code, Push Notifications, REST, AFNetworking, OpenAPI, Unit Testing
...
**Technologies:** Swift, REST, UIKit, CoreAnimation, UI in code, Unit Testing, UI Testing
...
**Technologies:** Swift, REST, UIKit, UI in code
...
**Technologies:** Objective-C, UIKit, UI in code, AFNetworking, AutoLayout, REST, Carthage, Unit Testing, CocoaPods

#### Whatt - social network
- iOS app for a social network
- Developed custom expandable TextView with links and tagging

**Technologies:** Objective-C, UIKit, UI in code, AFNetworking, AutoLayout, REST, Carthage, Unit Testing, CoreAnimation, CocoaPods
...
**Technologies:** Objective-C, UIKit, UI in code, AFNetworking, AutoLayout, REST, Carthage, Unit Testing, AVFoundation, CoreGraphics
...
**Technologies:** Objective-C, UI in code, UIKit, CoreData, REST, Unit Testing
...
**Technologies:** Swift, UIKit, UI in code, CoreData, AutoLayout, REST, ARKit
...
**Technologies:** Swift, UIKit, UI in code, CoreData, AutoLayout
...
**Technologies:** Swift, UIKit, UI in code, CoreData, AutoLayout, REST, CocoaPods

### Purch (Mar 2015 - Oct 2018) – iOS Developer
...
**Technologies:** Objective-C, UIKit, UI in code, Push Notifications, CoreAnimation, REST, Unit Testing, AutoLayout, Barcodes & QRCodes
...
**Technologies:** Swift, UIKit, UI in code, CoreAnimation, REST, Unit Testing, AutoLayout, Barcodes & QRCodes, Swift Package Manager
...
**Technologies:** Objective-C, UIKit, UI in code, CoreAnimation, REST, Unit Testing, AutoLayout, Barcodes & QRCodes
...
**Technologies:** Objective-C, UIKit, UI in code, CoreText, CoreGraphics, CoreAnimation, Carthage, In-App Purchase
...
**Technologies:** Objective-C, UIKit, UI in code, AFNetworking, AutoLayout, REST, Carthage
